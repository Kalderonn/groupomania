                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item border-0">
                                ...
                                <h2 class="accordion-header" id="headingTwo">
                                    <div class="accordion-button pointer d-flex justify-content-end collapsed"
                                ...
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div class="dropdown-item rounded d-flex justify-content-center align-items-center pointer text-muted p-1 collapsed"
                                        data-bs-toggle="collapse" data-bs-target="#collapsePost1" aria-expanded="false"
                                        aria-controls="collapsePost1">
